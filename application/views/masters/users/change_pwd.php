...
<form class="form-horizontal" id="resetForm" method="post" action="<?php echo $this->home."/change_password"; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-3">
            <span class="input-icon input-icon-right width-100">
                <input type="text" name="dname" id="dname" class="width-100" value="<?php echo $data->name; ?>"
                    disabled />
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-3">
            <span class="input-icon input-icon-right width-100">
                <input type="password" name="cpwd" id="cpwd" class="width-100" placeholder="รหัสผ่านปัจจุบัน" autofocus
                    required />
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-3">
            <p class="pull-right">
                <button type="button" class="btn btn-sm btn-success" onclick="changePassword()"><i
                        class="fa fa-save"></i> เปลี่ยนรหัสผ่าน</button>
            </p>
        </div>
